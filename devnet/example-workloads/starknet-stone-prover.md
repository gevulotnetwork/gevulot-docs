...
#### 2.1 Change the paths

The `fibonacci_private_input.json` file currently contains paths that are specific to your local file system. Change the paths to reference the files as shown below:
